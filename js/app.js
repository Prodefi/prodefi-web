(function ($) {
    ...
    function smoothScroll() {
        $('.navbar .nav-item .nav-link, .smooth-scroll  a, .smooth-scroll').on('click', function (event) {
            var $anchor = $(this);
            var headerH = '5';
            $('.header').outerHeight();
    ...
    carosuelMain.slick({
        ...
        infinite: false,
        prevArrow: '<button type="button" class="carosuel-arrow carosuel-arrow--vertical carosuel-arrow--prev"><i class="fas fa-angle-up"></i></button>',
        nextArrow: '<button type="button" class="carosuel-arrow carosuel-arrow--vertical carosuel-arrow--next"><i class="fas fa-angle-down"></i></button>',
        ...
        responsive: [{
            ...
            settings: {
                ...
                slidesToShow: 1,
                adaptiveHeight: true,
                prevArrow: '<button type="button" class="carosuel-arrow carosuel-arrow--vertical carosuel-arrow--prev"><i class="fas fa-angle-left"></i></button>',
                nextArrow: '<button type="button" class="carosuel-arrow carosuel-arrow--vertical carosuel-arrow--next"><i class="fas fa-angle-right"></i></button>',
            }
        }]
    });
    ...
    carosuelItem.each(function () {
        ...
        if ($.inArray(year, years) == -1) {
            yearsBreakpoint[year] = itemCount;
    ...
    $(".roadmap__year li").click(function() {
        var current_year = $(this).html();

        carosuelMain.slick('slickGoTo', yearsBreakpoint[current_year],false);
        $(".roadmap__year li").removeClass('active');
        $(this).addClass("active");
    });

    carosuelMain.slick('slickGoTo', yearsBreakpoint['2020'],true);
    ...
    // var lendingTabChange = function () {
    //     var tabs = $('#lending-tabs > li');
    //     var active;
    //     tabs.each(function() {
    ...
    // var assetTabChange = function () {
    //     var tabs = $('#asset-tabs > li');
    //     var active;
    //     tabs.each(function() {
    //         if ($(this).find('a.active').length !== 0) {
    //             active = $(this);
    ...
    // var digitalTabChange = function () {
    //     var tabs = $('#digital-tabs > li');
    //     var active;
    //     tabs.each(function() {
    //         if ($(this).find('a.active').length !== 0) {
    //             active = $(this);
    ...
    // };
    // // Tab Cycle function
    // var lendingTabCycle = setInterval(lendingTabChange, 5000);
    // var assetTabCycle = setInterval(assetTabChange, 5000);
    // var digitalTabCycle = setInterval(digitalTabChange, 5000);

    // // Tab click event handler
    // $('#lending-tabs a').on('click', function (e) {
    //     e.preventDefault();
    //     // Stop the cycle
    //     clearInterval(lendingTabCycle);
    //     // Show the clicked tabs associated tab-pane
    //     $(this).tab('show');
    //     // Start the cycle again in a predefined amount of time
    //     setTimeout(function () {
    //        lendingTabCycle = setInterval(lendingTabChange, 5000);
    //     }, 15000);
    // });
    // $('#asset-tabs a').on('click', function (e) {
    //     e.preventDefault();
    //     // Stop the cycle
    //     clearInterval(lendingTabCycle);
    //     // Show the clicked tabs associated tab-pane
    ...
    //     // Start the cycle again in a predefined amount of time
    //     setTimeout(function () {
    //        assetTabCycle = setInterval(assetTabChange, 5000);
    //     }, 15000);
    // });
    // $('#digital-tabs a').on('click', function (e) {
    //     e.preventDefault();
    //     // Stop the cycle
    //     clearInterval(lendingTabCycle);
    //     // Show the clicked tabs associated tab-pane
    ...
    //     // Start the cycle again in a predefined amount of time
    //     setTimeout(function () {
    //        digitalTabCycle = setInterval(digitalTabChange, 5000);
    //     }, 15000);
    // });
